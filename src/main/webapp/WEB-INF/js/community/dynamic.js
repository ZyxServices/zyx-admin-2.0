...
function initTable() {
    $('#dynamic_table').bootstrapTable({
        ...
        columns: [
            ...
            {field: 'userVo.nickName', title: '动态内容'},
            {field: 'userVo.authenticate', title: '发布人', sortable: true, formatter: authFormatter, sortName: 'md'},
            {field: 'userVo.nickName', title: '发布时间'},
            {field: 'topicContent', title: '评论数', sortable: true, width: 200},
            {field: 'createTime', title: '点赞数', formatter: timeFormat},
