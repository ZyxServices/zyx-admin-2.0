...
<head>
    ...
    <meta content="体育家-教程管理" name="description" />
    ...
    <div class="page-content">
        <div class="container-fluid" id="activityList">
            <div class="row-fluid">
                <div class="span12">
                    <h3 class="page-title">
                        教程攻略<small>statistics and more</small>
                    </h3>
            ...
            <div id="activity-list">
                <div class="row-fluid margin-bottom-10">
                    <div class="span6">
                        <a class="btn btn-default" href="javascript:void(0)" onclick="createActivity()">发布教程攻略</a>
                        <a class="btn btn-default" href="javascript:void(0)" onclick="manageLabel()">管理标签</a>
                    </div>
                </div>
                <h3 class="page-title"> 教程管理</h3>
                ...
                <div class="row-fluid">
                    ...
                    <form id="updateCreateFrom" enctype="multipart/form-data" class="form-horizontal" role="form">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select id="visible" name="visible" class="span1">
